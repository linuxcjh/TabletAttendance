...
public class AudioRecordViewLayout extends LinearLayout implements AudioManager.AudioStageListener {
    ...
    public AudioRecordViewLayout(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.inter_voice_bottom_layout, this);
        ...
        if (mCurrentState != state) {
            ...
            switch (mCurrentState) {
                case STATE_NORMAL:
                    ...
                    nameTv.setText(R.string.normal);

                    break;
                case STATE_RECORDING:
                    setBackgroundResource(R.drawable.button_recording);
                    nameTv.setText(R.string.recording);
                    if (isRecording) {
                ...
                case STATE_WANT_TO_CANCEL:
                    setBackgroundResource(R.drawable.button_recording);
                    nameTv.setText(R.string.want_to_cancle);
